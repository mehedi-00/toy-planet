...
const Gallery = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:-gap-0 md:mx-20 mx-5 my-10">
            ...
            <div className="hidden md:block border-4 rounded-xl border-emerald-900 " data-aos="zoom-in" data-aos-delay="500">
                <img className="rounded-xl h-auto w-[100%]" src="https://cf.shopee.com.my/file/9b069f3a06673451efb7c033de65b7ce" alt="" />
            </div>
